...
;globalThis.__BUNDLE_HASH__ = "de1ea9fa2570d1bad73645dd1bc0e9c79cd62a9cdc13eaa633ce3dbfbf4402a3";;(function bundleRequire(config) {
    globalThis.process = globalThis.process || {
        env: {
            NODE_ENV: "production",
        },
