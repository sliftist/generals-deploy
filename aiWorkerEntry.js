...
;globalThis.__BUNDLE_HASH__ = "dc0043d9964ccc2bdd4fc2806c509534e9a8ec1fb95bd844c276199055f598e4";;(function bundleRequire(config) {
    globalThis.process = globalThis.process || {
        env: {
            NODE_ENV: "production",
        },
