...
;globalThis.__BUNDLE_HASH__ = "db97f510436a3554db76c2a007079ca5784564904b75699d2ba2199dcca4e397";;(function bundleRequire(config) {
    globalThis.process = globalThis.process || {
        env: {
            NODE_ENV: "production",
        },
