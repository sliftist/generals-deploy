...
;globalThis.__BUNDLE_HASH__ = "506114034541e1972d64d2372ffa6af4cd07c279bde0214de79752290615d501";;(function bundleRequire(config) {
    globalThis.process = globalThis.process || {
        env: {
            NODE_ENV: "production",
        },
