...
(0, registry_1.registerStrategy)("dominion", (snapshot, ctx) => {
    const cfg = ctx.config;
    const falloff = num(cfg.falloff, 2); // mirror ARMY_FALLOFF_EXPONENT in the engine
...
// merged inline sourcemap
 /* _JS_SOURCE_HASH = "94548a226a675ceb16c74673a8dfe9ae8fb2ff83133dd84610bc149d308ac2c1"; */
    }) });
...
;globalThis.__BUNDLE_HASH__ = "9107b7eb2542fc1950b0d0b2ace304781272cf083e81342dfabc6f425429fb8d";;(function bundleRequire(config) {
    globalThis.process = globalThis.process || {
        env: {
            NODE_ENV: "production",
        },
